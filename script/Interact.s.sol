...
contract ClaimAirdrop is Script {
    ...
    bytes32 PROOF_THREE = 0xc2ef27e475b955c035da5b0bb2847aaadfab48761646acc36250572a3d56cbd3;
    ...
    function fundAirdrop(address airdrop) public {
        vm.startBroadcast();
        ERC20Token(MerkleAirdrop(airdrop).getAirdropToken()).mint(airdrop, 1000 ether);
        vm.stopBroadcast();
    }

    function splitSignature(bytes memory sig) public pure returns (uint8 v, bytes32 r, bytes32 s) {
        require(sig.length == 65, "ClaimAirdropScript: Invalid Signature");
        assembly {
    ...
    function run() external {
        ...
        fundAirdrop(mostRecentlyDeployed);
